...
a, b, c = tuple(zip(subjects, scores))
print(a, b, c)
...
print(
    result
)  # 튜플로 묶어서 튜플로 변환, 즉 제너레이터의 () 생략 하고 튜플 ()만으로도 사용가능
...
# 총 재고 금액 출력
print(sum(b * c for _, b, c in stocks))
# total = sum(i[1] * i [2] for i in stocks)
# ✅ 총액: 21,000원


stocks = (("사과", "바나나", "체리"), (1000, 2000, 5000), (5, 3, 2))

print(sum(b * c for _, b, c in zip(*stocks)))
